...
def test():
    ...
    # T1 = construct_tree_example()
    # T1.rotate("L", T1.right)
    # tests["Problem 2 Tests:"] = [
    #     {
    #         "label": "Basic Rotate 2.1a",
    #         "input": T1,
    #         "test": lambda T: multi_getattr(T, "right.key",  None),
    #         "expected": 80,
    ...
    #         "input": T1,
    #         "test": lambda T: multi_getattr(T, "right.right",  None),
    #         "expected": None,
    #         "show_expectation": False
    #     },
    #     {
    ...
    #         "input": T1,
    #         "test": lambda T: multi_getattr(T, "right.left.key",  None),
    #         "expected": 6,
    #         "show_expectation": False
    #     },
    #     {
    ...
    #         "input": T1,
    #         "test": lambda T: multi_getattr(T, "right.left.right.key",  None),
    #         "expected": 60,
    #         "show_expectation": False
    #     },
    # ]
