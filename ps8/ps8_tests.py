...
import random
random.seed(120)
from ps8_helpers import timeout, color, generate_line_of_ring_subgraphs, generate_random_linked_cluster, validate_graph_coloring, generate_line_of_complete_subgraphs, generate_complete_graph
...
def test_2_coloring():
    ...
    tests["BFS 2-Coloring"] = [] 
    tests["BFS 2-Coloring"] += [generate_test("Should work on 2-colorable graphs", g, lambda g: validate_graph_coloring(g, bfs_2_coloring(g)), lambda g: True) for g in testcases["2-colorable"]]
    tests["BFS 2-Coloring"] += [generate_test("Should not work on k>3-colorable graphs", g, lambda g: validate_graph_coloring(g, bfs_2_coloring(g)), lambda g: False) for g in testcases["k>3-colorable"]]
    run_tests(tests)
...
def test_3_coloring():
    ...
    tests["ISET 3-Coloring"] = [] 
    tests["ISET 3-Coloring"] += [generate_test("Should work on 2-colorable graphs", g, lambda g: validate_graph_coloring(g, iset_bfs_3_coloring(g)), lambda g: True) for g in testcases["2-colorable"]]
    tests["ISET 3-Coloring"] += [generate_test("Should work on 2-or-3-colorable graphs", g, lambda g: validate_graph_coloring(g, iset_bfs_3_coloring(g)), lambda g: True) for g in testcases["2-or-3-colorable"]]
    tests["ISET 3-Coloring"] += [generate_test("Should work on 3-colorable graphs", g, lambda g: validate_graph_coloring(g, iset_bfs_3_coloring(g)), lambda g: True) for g in testcases["3-colorable"]]
    tests["ISET 3-Coloring"] += [generate_test("Should not work on k>3-colorable graphs", g, lambda g: validate_graph_coloring(g, iset_bfs_3_coloring(g)), lambda g: False) for g in testcases["k>3-colorable"]]
